...
def keypoints_video_person_segmentation(input_video_path, output_video_path):

    print("Function for Segmenting Person/Human using Keypoints (Without Drawing keypoints) from an input video starts here....")
            ...
            for r in sam_results:
                if r.masks is not None:
                    ...
                    for mask_tensor in r.masks.data:
                        ...
                        # mask_3_channel = cv2.merge([mask, mask, mask]) # Not directly used for blending, but good for understanding
    ...
    print("The process of segmenting persons/humans using Keypoints (without draw) finished successfully")